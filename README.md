...
بک‌اند NestJS با دیتابیس PostgreSQL واقعی، مدل‌های دامنه (Product, Category, User) با روابط واقعی بین آن‌ها، و سیستم احراز هویت کامل (JWT) پیاده‌سازی شده. فرانت‌اند هنوز نسخه‌ی استاتیک اولیه است.
